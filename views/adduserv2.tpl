        ...
        <div id="page-wrapper">
          <div class="row">
            <div class="col-md-6">
              ...
              <p>HangarHero could be up and operating live in your business today!  All you need is a credit card, an internet connection, and an ordinary internet browser.  We require no special hardware, software, or plugins.  Most users can achieve basic proficiency in less than an hour using our online video instruction materials.</p>
