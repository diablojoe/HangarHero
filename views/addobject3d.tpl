    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container">
        <div id="page-wrapper">
          ...
          {{end}}
          <form class="form-horizontal" action="/admin/addobject3d" method="post">
            <fieldset>
              <legend>Add Unbound Object3D</legend>
              ...
              <div class="form-group">
                <label for="icao" class="col-lg-2 control-label">ICAO</label>
                <div class="col-lg-6">
