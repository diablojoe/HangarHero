...
<body>
    <header id="header" class="skels-layers-fixed">
        <h1><strong><a href="/">HangarHero</a></strong></h1>
        <nav id="nav">
            <ul>
                <li><a href="/">Home</a></li>
            </ul>
        ...
        <div class="container">
            ...
            <form action="/adduser" method="post" id="form">
                <div class="row uniform">
                    ...
                    <div class="6u 12u$(xsmall)">
                        <input type="text" name="orgname" id="orgname" value="" placeholder="Organization Name" />
                    </div>
                    <br>
                    <div class="6u 12u$(xsmall)">
                    ...
                    <div class="6u 12u$(xsmall)">
                        <input type="text" name="state" id="state" value="" placeholder="State/Province" />
                    </div>
                    <div class="6u 12u$(xsmall)">
                    ...
                    <div class="6u 12u$(xsmall)">
                        <input type="text" name="telephone" id="telephone" value="" placeholder="Telephone Number" />
                    </div>
                    <div class="6u 12u$(xsmall)">
                    ...
                    <div class="6u 12u$(xsmall)">
                        <input type="password" name="password2" id="password2" value="" placeholder="Re-Type Password" />
                    </div>
                    <div class="12u$">
                        <ul class="actions">
                            <li>
