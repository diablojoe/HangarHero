...
<head>
    ...
    <title>Update Account Success - HangarHero.com</title>
  ...
  <div id="wrapper">
      ...
      <div class="container">
        <div id="page-wrapper">
          <div class="alert alert-dismissible alert-success">
            ...
            <strong>Account Update Success: </strong> This change can take up to 30 minutes to reflect in your account. You will be redirected to the <a href="/account">account management screen</a> shortly
          </div>
    ...
    $(document).ready(function () {
        ...
        window.setTimeout(function () {
            location.href = "https://hangarhero.com/account";
        }, 5000);
    });
    </script>
  </body>
