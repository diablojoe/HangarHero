    ...
    <nav class="navbar navbar-default">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="/managerv2/{{.hangar}}">Back to Schedule</a></li>
              <li class="dropdown">
      ...
      <div class="container">
        <div id="page-wrapper">
          <div class="row">
            <div class="col-md-9"><!--3d space -->
              ...
              <div class="row">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="center-block btn-success" onclick="save()">Save</button>
                  </div>
                </div>
              </div>
            </div><!-- end 3dspace -->
          ...
          <!--  Show Error Modal -->
          <div id="goodsave" class="modal fade" role="dialog">
            <div class="modal-dialog">
              <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Position Saved</h4>
                </div>
                <div class="modal-body">
...
<!--
    ...
    <script type="text/javascript" src="/static/js/renderv2.js"></script>
    </body>
</html>
