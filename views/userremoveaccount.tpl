...
<head>
    ...
    <title>Remove Account - HangarHero.com</title>
    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container">
        <div id="page-wrapper">
          ...
          <div class="alert alert-dismissible alert-danger">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <strong>Cancel Subscription Warning:</strong> Subscription cancelations are applied imediatly and do not qualify for pro-rated refunds. All hangars, aircraft, equipent, and viewers will be deleted from our system. To procede please verify your E-mail address and Password.
          </div>
          <form action="/removeaccount" method="post" class="form-horizontal" id="form">
            <fieldset>
