...
<head>
    ...
    <title>Remove Viewer - HangarHero.com</title>
    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container">
        <div id="page-wrapper">
          ...
          {{end}}
          {{range $key, $val := .success}}
          <div class="alert alert-dismissible alert-success">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <strong>{{$key}}</strong> {{$val}}
          </div>
          {{end}}
          <form action="/removeviewer" method="post" class="form-horizontal" id="form">
            <fieldset>
            <legend>Remove Viewer</legend>
