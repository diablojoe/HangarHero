    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container">
        <div id="page-wrapper">
          ...
          {{end}}
          <form class="form-horizontal" action="/admin/addequipmentcat" method="post">
            <fieldset>
              <legend>Add Equipment Category</legend>
            ...
            <tbody>
              {{range $key, $val := .eqcats}}
                <tr>
                  <td>{{$key}}</td>
                  <td>{{$val}}</td>
                  <td><a href="#" class="btn btn-warning update" data-id="{{$key}}" data-name="{{$val}}">Update</a></td>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="form-horizontal" action="/admin/addequipmentcat" method="post">
                    <fieldset>
                      <legend>Update Equipment Category</legend>
                      <div class="form-group">
                        <label for="name" class="col-lg-2 control-label">Name</label>
                        <div class="col-lg-6">
